// Ejercicio T2 - Base de Datos UrbanStyle_Store
// Curso: Base de Datos Avanzado II
// Alumno: JOSE GORGE MONTERO VILCAS
// Trabajando con UrbanStyle_Store, una tienda de ropa

// Primero, creamos y seleccionamos la base de datos UrbanStyle_Store
...
// Insertamos los clientes (inserción masiva)
...
// Verificamos que todas las colecciones se crearon correctamente
print("✅ Sucursales insertadas: " + db.branch.countDocuments());
print("✅ Clientes insertados: " + db.clients.countDocuments());
print("✅ Vendedores insertados: " + db.sellers.countDocuments());
print("✅ Productos insertados: " + db.products.countDocuments());
print("\n✅ ¡Base de datos UrbanStyle_Store lista para el examen T2!");
